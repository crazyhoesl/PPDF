...
| OpenAI      | `gpt-5.4` (flagship)        | `OPENAI_API_KEY`     | [platform.openai.com](https://platform.openai.com/api-keys) |
| Anthropic   | `claude-opus-4-7` (flagship)| `CLAUDE_API_KEY`     | [console.anthropic.com](https://console.anthropic.com/) |
